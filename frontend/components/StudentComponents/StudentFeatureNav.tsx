...
import { Moon, Sun, Home } from "lucide-react"; // Icons for Dark/Light mode
...
export default function FeaturePageNavbar() {
  ...
  const scrollToFeatures = () => {
    const featuresSection = document.getElementById("journey");
  ...
  const scrollToSteps = () =>{
    ...
    const stepsSection = document.getElementById("features");
    if (stepsSection) {
  ...
  return (
    ...
    >
      ...
      <NavbarContent as="div" justify="end" className="flex items-center gap-4">
        ...
        <NavbarItem>
          <Popover triggerType="menu" placement="bottom" showArrow backdrop="transparent" offset={2} shadow="md">
            <PopoverTrigger>
              <Link
