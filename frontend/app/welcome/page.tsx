...
import { BackgroundLinesDemo } from "../../components/CommonComponents/LandingPage";
import { TabsDemo } from "../../components/CommonComponents/FeatureTab";
import {  StickyScrollRevealDemo } from "../../components/CommonComponents/Steps";
...
const Welcome = () => {
  return (
    <div className=" dark:bg-black bg-white " >
      ...
      <div className="pb-[100px]  dark:bg-black bg-white " id='demo' >
     
      <HeroScrollDemo/>
     </div>
      <div id="features" className="mx-4  md:mx-[100px]">
        <TabsDemo />
      </div>
      <div className="py-[100px] md:pt-[220px] dark:bg-black bg-white " id="steps">
     
      <StickyScrollRevealDemo/>
      </div>

<div className="pt-0 dark:bg-black">
